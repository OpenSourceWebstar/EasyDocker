...
viewLogsAppMenu()
{
    ...
    echo ""
    isOption "1. Show the logs live"
    isOption "2. Show last 20 lines"
    isOption "3. Show last 50 lines"
    isOption "4. Show last 100 lines"
    isOption "5. Show last 200 lines"
    isOption "6. Show full log"
