...
function_scripts=(
    ...
    "function/file/empty_line/check.sh"
    "function/file/empty_line/remove.sh"
    ...
    "function/run/init.sh"
    "function/run/reinstall.sh"
    "function/run/start.sh"
    "function/run/update.sh"
